...
function [fitObjs] = plotsubplot1(dc, ix, iy, ixData, iyData, iSubplot, gridSize)    
    ...
    markerSizes={2, 10, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8};
...
function [dc, ix, iy, ixData, iyData, iSubplots, gridSize] = parsearguments(varargin)
    ...
    validMixWithinDatum=@(x) isa(x,'logical');
    ...
    ip.addParameter('mixWithinDatum', defaultMixWithinDatum, validMixWithinDatum);
